...
export default class App extends Component {
  ...
  sendNotification() {
    ...
    fetch('https://onesignal.com/api/v1/notifications', {
      ...
      body: JSON.stringify({
        // "app_id": "3f086164-3a8f-4120-9123-facbdbfcffa4", // ZO
        "app_id": "b86c026a-8a6f-4018-b821-f32c44975830", // Testing
        "data": { "foo": "bar" },
        "included_segments": this.state.segments,
        // "template_id": '5cc1c9a7-99eb-45ab-be97-9702ddd77a9b', // ZO
        "template_id": this.state.templateId,
        "contents": { "en": overdueUsers ? `Anda Memiliki {{ invoice_overdue | default: '0'}} Invoice yang sudah Overdue` : this.state.message },
  ...
  render() {
    let Segments = [
      ...
      //   title: 'One Overdue',
      //   onPress: () => {
      //     this.state.segmentsName.push('One Overdue')
      //     this.state.segments.push('Overdue Equals To One')
      //     this.forceUpdate()
      //   }
      // },
      // {
      //   title: 'Overdue More Than One',
      //   onPress: () => {
      //     this.state.segmentsName.push('Overdue More Than One')
      //     this.state.segments.push('Overdue More Than One')
      //     this.forceUpdate()
      //   }
      // },
      {
